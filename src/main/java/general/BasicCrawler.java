...
public class BasicCrawler {
    ...
    private  BasicCrawler instance = null;
    ...
    public  String crawlPage(String url,String encoding) throws  Exception{
        if(instance==null) {
            instance = new BasicCrawler();
        }
        crawler.setUrlnoCheck(url.trim());
    ...
    public static void main(String[] args) throws IOException{
        ...
        String content = crawler1.crawlPage("http://baike.baidu.com/view/1.htm");
