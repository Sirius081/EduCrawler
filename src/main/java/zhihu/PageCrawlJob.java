...
public class PageCrawlJob {
    ...
    public void writeToDB( String url, Document doc) throws Exception {
        ...
        try {
            ...
            ArrayList<Comment> comments= PageParserJob.parseComments(url);
            // insert into database
            pageId=pDao.insertPage(sourceId, url, titleStr, date, pubSource, content,comments);
            pDao.deleteList(url);
